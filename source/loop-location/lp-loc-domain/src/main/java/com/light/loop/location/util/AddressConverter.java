package com.light.loop.location.util;
...
import com.light.loop.location.vo.GoogleResponse;
import com.light.loop.location.vo.Result;
...
public class AddressConverter {
 ...
 public static void main(String[] args) throws IOException {
  ...
  GoogleResponse res = new AddressConverter().convertToLatLong("HIA, Doha, Qatar");
  ...
  System.out.println("\n");
  GoogleResponse res1 = new AddressConverter().convertFromLatLong("25.2594916,51.6122411");
		  //"18.92038860,72.83013059999999");
